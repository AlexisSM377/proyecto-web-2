                                    ...
                                    <table class="table user-table no-wrap">
                                        ...
                                        <tr>
                                            ...
                                            <div class="row col-12">
                                                <div class="col-4">                                                
                                                    <a class="btn btn-success m-3" href="register/{{$register->id}}"  ><i class="fas fa-eye"></i></a>
                                                </div>
                                                <div class="col-4">
                                                    <a class="btn btn-warning m-3" href="register/{{$register->id}}/edit"  ><i class=" fas fa-edit"></i></a>
                                                </div>
