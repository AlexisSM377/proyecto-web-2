...
<!-- parte de arriva del contenedor jaja  -->
<div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    ...
                    <!-- este boton hay que moverlo :p -->
                    <div class="col-md-6 col-4 align-self-center">
                        <div class="text-end upgrade-btn">
                            <a href="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS29QGgXRJ8Elo8JetEymixUyJDf9y5sCdl2bIGE5iaK_9B-A8d1_nptGF4LP6C67Fa05I&usqp=CAU"
                                class="btn btn-success d-none d-md-inline-block text-white" target="_blank">Tocame :3
                                </a>
                        </div>
                    </div>
                </div>
