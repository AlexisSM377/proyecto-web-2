            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Dietas tabla</h4>
                                <div class="table-responsive">
                                    <table class="table user-table no-wrap">
                                        <thead>
                                            <tr>
                                                <th class="border-top-0">Id</th>
                                                <th class="border-top-0">Dietas/th>
                                        ...
                                        <tr>
                                            ...
                                            <div class="row col-12">
                                                <div class="col-4">                                                
                                                    <a class="btn btn-success m-3" href="diet/{{$diet->id}}"  ><i class="fas fa-eye"></i></a>
                                                </div>
                                                <div class="col-4">
                                                    <a class="btn btn-warning m-3" href="diet/{{$diet->id}}/edit"  ><i class=" fas fa-edit"></i></a>
                                                </div>
                                                <form action="diet/{{$diet->id}}" method="POST">
                                                    {!! csrf_field() !!}
                                                    @method("delete")
